...
class ChatService {
  static Future<Map<String, dynamic>> getChatSessions({
    ...
    try {
      final response = await request.get('${ApiConstants.baseUrl}/chat/sessions/');
  ...
  static Future<Map<String, dynamic>> getMessages({
    ...
    try {
      final response = await request.get(
        '${ApiConstants.baseUrl}/chat/messages/$sessionId/',
      );
  ...
  static Future<Map<String, dynamic>> markMessagesRead({
    ...
    try {
      final response = await request.postJson(
        '${ApiConstants.baseUrl}/chat/mark_read/',
  ...
  static Future<Map<String, dynamic>> createChatWithCoach({
    ...
    try {
      final response = await request.post(
        '${ApiConstants.baseUrl}/chat/create/$coachId/',
        {},
      );
  ...
  static Future<Map<String, dynamic>> createAttachment({
    ...
    try {
      final response = await request.postJson(
        '${ApiConstants.baseUrl}/chat/create_attachment/$sessionId/',
        jsonEncode({
  ...
  static Future<Map<String, dynamic>> uploadFileAttachment({
    ...
    try {
      final url = '${ApiConstants.baseUrl}/chat/upload_attachment/$sessionId/';
