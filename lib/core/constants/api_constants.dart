...
class ApiConstants {
  ...
  static const String baseUrl =
      'http://127.0.0.1:8000'; // For Web/iOS Simulator
  ...
  static String adminBookingDetail(int bookingId) =>
      '$adminApiBase/bookings/$bookingId/';
  static String adminBookingUpdateStatus(int bookingId) =>
      '$adminApiBase/bookings/$bookingId/update-status/';
  static String adminBookingDelete(int bookingId) =>
      '$adminApiBase/bookings/$bookingId/delete/';

  // Payments
  static const String adminPayments = '$adminApiBase/payments/';
  static String adminPaymentDetail(int paymentId) =>
      '$adminApiBase/payments/$paymentId/';
  static String adminPaymentUpdateStatus(int paymentId) =>
      '$adminApiBase/payments/$paymentId/update-status/';

  // Users
  static const String adminUsers = '$adminApiBase/users/';
  static String adminUserDetail(int userId) => '$adminApiBase/users/$userId/';
  static String adminUserUpdateStatus(int userId) =>
      '$adminApiBase/users/$userId/update-status/';

  // Coaches
  static const String adminCoaches = '$adminApiBase/coaches/';
  static String adminCoachDetail(int coachId) =>
      '$adminApiBase/coaches/$coachId/';
  static String adminCoachVerify(int coachId) =>
      '$adminApiBase/coaches/$coachId/verify/';
